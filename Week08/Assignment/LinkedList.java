 ...
 * Data Structure Class for LinkedList
 */
...
// ADD MORE METHODS HERE (like for assigned CS211 work):
    ...
    public E deleteBack() {
        ...
        E value = back.prev.data;
        remove(size() - 1);
        return value;
    }

    // Exercise 16.8 stutter
    // switches each pair of values (0 and 1, 2 and 3, etc.) if odd the last value is ignored
    public void switchPairs() {        
        ListNode<E> currentNode = front.next;
        ListNode<E> nextNode = currentNode.next;
        
        E val1, val2;
        while ( nextNode != null && nextNode != back ) {
            val1 = currentNode.data;
            val2 = nextNode.data;
